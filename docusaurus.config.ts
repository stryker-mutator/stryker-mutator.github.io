...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content:
        '📣 Discover the <a target="_blank" href="https://fosdem.org/2024/schedule/event/fosdem-2024-1683-who-s-testing-the-tests-mutation-testing-with-strykerjs/">"Who\'s testing the tests? Mutation testing with StrykerJS"</a> talk on FOSDEM 2024.',
    ...
    prism: {
      additionalLanguages: ['java', 'scala', 'csharp', 'diff', 'json'],
      theme: themes.github,
