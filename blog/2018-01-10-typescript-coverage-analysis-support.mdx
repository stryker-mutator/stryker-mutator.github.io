...
Please read [our blog article on transpiling code](./2017-10-06-typescript-support.mdx) if your interested in the details on how transpilers are implemented in Stryker.
