...
If you're new to mutation testing, it's a way to measure your tests' effectiveness. Please look at [our RoboCoasters 🤖🎢 example](https://stryker-mutator.io/example) and see how even 100% code coverage doesn't tell the whole story. Mutation testing is the only way to make sure you're not missing any tests.
