...
Enable real-time reporting with `dotnet stryker --open-report` (or `-o` for short) in Stryker.NET!
...
<video autoPlay controls src="/videos/realtime-reporting.mp4" width="100%" height="100%" />
