...
which is an open standard for reporting mutation test results. See our [previous blog](./2019-04-03-one-mutation-testing-html-report.mdx) for more information about the mutation-testing-elements
